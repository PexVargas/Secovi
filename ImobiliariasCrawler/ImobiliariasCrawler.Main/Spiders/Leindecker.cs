    ...
    public class Leindecker : SpiderBase
    {
        ...
        public void ParseImovel(Response response)
        {
            ...
            var imovel = new ImoveiscapturadosDto(SpiderEnum.Leindecker, tipoImovelEnum)
            {
                ...
                Quartos = response.Selector.SelectSingleNode("//small[contains(text(),'Dorm')]/..").ReFirst(@"\d+"),
                Garagens = response.Selector.SelectSingleNode("//small[contains(text(),'Vagas')]/..").ReFirst(@"\d+"),
                Suites = response.Selector.SelectSingleNode("//small[contains(text(),'Suíte')]/..").ReFirst(@"\d+"),

    ...
    public class Leindecker : SpiderBase
    {
        ...
        public void ParseImovel(Response response)
        {
            ...
            var imovel = new ImoveiscapturadosDto(SpiderEnum.Leindecker, tipoImovelEnum)
            {
                ...
                Quartos = response.Selector.SelectSingleNode("//small[contains(text(),'Dorm')]/..").TextOrNull(),
                Garagens = response.Selector.SelectSingleNode("//small[contains(text(),'Vagas')]/..").TextOrNull(),
                Suites = response.Selector.SelectSingleNode("//small[contains(text(),'Suíte')]/..").TextOrNull(),
                Valor = response.Selector.SelectSingleNode("//small[contains(text(),'Valor')]/..").TextOrNull(),

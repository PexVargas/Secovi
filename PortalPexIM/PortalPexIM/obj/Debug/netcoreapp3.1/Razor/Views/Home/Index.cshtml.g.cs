#pragma checksum "C:\Users\Admin\Desktop\ASPNETCoreWithReact\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ea89d5a88dfc93f9208f2c3b1e0284999754291c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ea89d5a88dfc93f9208f2c3b1e0284999754291c", @"/Views/Home/Index.cshtml")]
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ea89d5a88dfc93f9208f2c3b1e0284999754291c6647", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ea89d5a88dfc93f9208f2c3b1e0284999754291c9237", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ea89d5a88dfc93f9208f2c3b1e0284999754291c11817", async() => {
#nullable restore
            ...
            success: function (result) {
                ...
                if (result.length == 0) {
                    if (possuiCidades == false) {
                        ...
                        $('.numQtdOfe').html('<span");
            WriteLiteral(@" class=""numSemNum"">Sem registros, por favor modifique a busca!</span>');
                    }
  ...
  ");
    ...
    ");
            WriteLiteral(@"                var processed_json = [];
                    ...
                    CarregarGraficoEvolutivo(""graficoEvolutivo"", categories[0], dadosGrafico, ""Evolutivo de ofertas"", ""column"", ""12"");
                }
    ...
    function CarregarGraficoCidades() {
        $('.moda");
            WriteLiteral(@"l-loading-local').show();
        $('#graficoCidades').hide();
        var processed_json = new Array();
        $.ajax({
            type: ""POST"",
    ...
    function CarregarGraficoBairros() {
        ...
        $.ajax({
            ...
            WriteLiteral(@") {
                    ...
                    CarregarGrafico(""graficoBairros"", categories[0], dadosGrafic");
            WriteLiteral(@"o, ""Oferta por bairros"", ""bar"", ""6"");
                }
            },
            error: function (err) {
            }
    ...
    function CarregarGraficoTipos() {
        ...
        $.ajax({
            ...
            WriteLiteral(@"       for (i = 0; i < result.length; i++) {
                    ...
                    CarregarGrafico(""");
            WriteLiteral(@"graficoTipos"", categories[0], dadosGrafico, ""Tipo de imóvel"", ""bar"", ""6"");
                }
            },
            error: function (err) {
            }
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.length == 0) {
                    ...
                    CarregarGraficoPizza(""grafi");
            WriteLiteral(@"coGaragens"", ""Garagens"", result);
                }
            },
            error: function (err) {
            }

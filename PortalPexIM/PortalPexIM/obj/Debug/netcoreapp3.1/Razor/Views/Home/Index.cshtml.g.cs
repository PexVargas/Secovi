#pragma checksum "C:\Users\Admin\Desktop\ASPNETCoreWithReact\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c62669020e349e1617cc240a7178e9d7e4e79403"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c62669020e349e1617cc240a7178e9d7e4e79403", @"/Views/Home/Index.cshtml")]
...
#nullable restore
#line 137 "C:\Users\Admin\Desktop\ASPNETCoreWithReact\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c62669020e349e1617cc240a7178e9d7e4e794036647", async() => {
#nullable restore
#line 139 "C:\Users\Admin\Desktop\ASPNETCoreWithReact\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
...
#nullable disable
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 140 "C:\Users\Admin\Desktop\ASPNETCoreWithReact\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                }
...
#nullable restore
#line 146 "C:\Users\Admin\Desktop\ASPNETCoreWithReact\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c62669020e349e1617cc240a7178e9d7e4e794039237", async() => {
#nullable restore
#line 148 "C:\Users\Admin\Desktop\ASPNETCoreWithReact\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
...
#nullable disable
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 149 "C:\Users\Admin\Desktop\ASPNETCoreWithReact\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                }
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c62669020e349e1617cc240a7178e9d7e4e7940311817", async() => {
#nullable restore
        ...
        <div class=""card"">
            ...
            <div class=""card-body ab"">
                <div class=""row"">
                    ...
                    <div class=""col-md-12"">
                   ");
            WriteLiteral(@"     <p class=""card-body minmaxcv valorcv"">cv:</p>
                    </div>
                    <br />
                </div>
    ...
    <div class=""col-md-6"">
        <div class=""card"">
            ...
            <div class=""card-body cd"">
                ...
                <div class=""row"">
                    <div class=""col-md-12"">
                        <h3 class=""card-body numMetMed"">Sem registros, por favor modifique a b");
            WriteLiteral("usca!</h3>\r\n                    </div>\r\n");
            WriteLiteral(@"
...
<script>
   ...
   ");
        ...
        $.ajax({
            ...
            WriteLiteral(@"mSemNum"">Sem registros, por favor modifique a busca!</span>');
                    ...
                    if (result[result.length - 1].maximo != null)
                        $('.valormax').html(result[result.length - 1].maximo.toString());
                    if (result[result.length - 1].minimo != null)
                        $('.valormin').html(result[result.length - 1].minimo.toString());
            ...
            ");
            WriteLiteral(@"                $('.numQtdOfe').removeClass('qtdVermelho');
            ...
            WriteLiteral(@"                       } else {
                    ...
                    for (i = 0; i < result.length; i++) {
                        if (pagAtual == 'Quantidade de ofertas')
                            ...
                            processed_json.push([result[i].key, result[i].key + "" - R$"" + result[i].value, result[i].value]);
                    }
                ...
                if (result.length == 0) {
                    ...
                    for (i = 0; i < result.length; i++) {
                        ...
                        if (i >= 15) {
                            ...
                            if (pagAtual == 'Quantidade de ofertas')
                                processed_js");
            WriteLiteral(@"on.push([result[i].key, result[i].key + "" - "" + result[i].value, result[i].value]);
                            else
                                processed_json.push([result[i].key, result[i].key + "" - R$"" + result[i].value, result[i].value]);
                    }
    ...
    function CarregarGraficoBairros() {
     ...
     ");
            WriteLiteral(@"                   dadosGrafico.push({
                            name: dadosPivot[i].shift(),
                            data: dadosPivot[i]
                        });
                    }
    ...
    function CarregarGraficoTipos() {
        ...
        $.ajax({
            ...
            success: function (result) {
                $('.mod");
            WriteLiteral(@"al-loading-local').hide();
                $('#graficoTipos').show();
                    ...
                    for (i = 0; i < result.length; i++) {
                        ...
                        if (i >= 15) {
                            ...
                            if (pagAtual == 'Quantidade de ofertas')
                                ...
                                processed_json.push([result[i].key, result[i].key + "" - R$");
            WriteLiteral(@""" + result[i].value, result[i].value]);
                    }
    ...
    function CarregarGraficoPizza(id, titulo, dados) {
        ...
        $.each(dados, function (i, obj) {
            ...
            if (!resultObject) {
               ");
            WriteLiteral(@" dadosProcessados.push(agregador)
            }
            else {
        ...
        Highcharts.chart(id, {
            ...
            series: [{
                ...
                colorByPoint: true,
  ");
            WriteLiteral(@"              data: dadosProcessados
            }]
        });
    }
    ...
    function getPivotArray(dataArray, rowIndex, colIndex, dataIndex) {
        ...
        for (var key in result) {
            ...
            item.push(key);
            for (var i =");
            WriteLiteral(@" 0; i < newCols.length; i++) {

#pragma checksum "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "147165bddab390f0c21ff603a8a8d6fa8493dfb5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"147165bddab390f0c21ff603a8a8d6fa8493dfb5", @"/Views/Home/Index.cshtml")]
...
#nullable restore
#line 140 "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "147165bddab390f0c21ff603a8a8d6fa8493dfb56653", async() => {
#nullable restore
#line 142 "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
...
#nullable disable
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 143 "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                }
...
#nullable restore
#line 149 "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "147165bddab390f0c21ff603a8a8d6fa8493dfb59239", async() => {
#nullable restore
#line 151 "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
...
#nullable disable
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 152 "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                }
...
#nullable restore
#line 157 "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "147165bddab390f0c21ff603a8a8d6fa8493dfb511815", async() => {
#nullable restore
#line 159 "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
...
#nullable disable
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 160 "C:\Users\vinic\OneDrive\Documentos\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                }
...
<script>
    ...
    $(document).ready(function () {
      ...
      ");
            WriteLiteral(@"      $('.datetimepicker').datetimepicker('destroy');
            ativaNovamenteDate();
        });
    ...
    function Pesquisar(pagina) {
        if ($(""#c");
            WriteLiteral(@"mbTipoImovel"").is(':checked'))
            tipoimovel = 2;
        else
            tipoimovel = 1;
    ...
    function CarregarGraficoMeses() {
        ...
        $.ajax({
            ...
            WriteLiteral(@" == 0) {
             ...
             ");
            WriteLiteral(@"                   $('.valormax').html(result[result.length - 1].maximo.toLocaleString('pt-BR'));
  ...
  ");
            WriteLiteral(@"                      } else {
                    ...
                    for (i = 0; i < result.length; i++) {
                        if (pagAtual == 'Quantidade de ofertas')
                            processed_json.push([result[i].key, result[i].key + "" - "" + result[i].value, resul");
            WriteLiteral(@"t[i].value]);
                        else
    ...
    function CarregarGraficoCidades() {
        var pagAtual =");
            WriteLiteral(@" $('#tituloCalculo').html();
        $('.modal-loading-local').show();
        $('#graficoCidades').hide();
        var processed_json = new Array();
        $.ajax({
            ...
            WriteLiteral(@"quantidade = 0;
                    ...
                    if (quantidade < 10) {
                     ...
                     ");
            WriteLiteral(@"   $('.lblquadroOfertasCidades').addClass('qtdVermelho');
                    } else {
        ...
        $.ajax({
            ...
            WriteLiteral(@"i < result.length; i++) {
                    ...
                    if (quantidade < 10) {
                        ...
                        $('.lblquadroOfertasBairros').addClass('qtdVerme");
            WriteLiteral(@"lho');
                    } else {
                        $('.quadroOfertasBairros').removeClass('qtdVermelho');
        ...
        $.ajax({
            ...
            WriteLiteral(@"].key;
                    ...
                    if (quantidade < 10) {
                        ...
                        $('.quadroOf");
            WriteLiteral(@"ertasTipos').removeClass('qtdVermelho');
 ...
 ");
            ...
            exporting: {
                ...
                buttons: {
                    contextButton: {
                        menuItems: [""viewFullscreen"", ""printChart"", ""separator"", ""download");
            WriteLiteral(@"PNG"", ""downloadJPEG"", ""downloadPDF"", ""downloadSVG"", 'separator', ""label""]
                    }
                }
            }
        });
    ...
    function CarregarGraficoPizza(id, titulo, dados) {
        ...
        Highcharts.chart(id, {
            ...
            exporting: {
                menuItemDefinitions: {
                    ");
            WriteLiteral(@"// Custom definition
                    label: {
                        onclick: function (vai, cavalo) {
                            debugger
                            alert(vai.path[4].id)
    ...
    function getPivotArray(dataArray, rowIndex, colIndex, dataIndex) {
        ...
        for (var i = 0; i < dataArray.length; i++) {
            ...
            result[dataArray[i][rowIn");
            WriteLiteral(@"dex]][dataArray[i][colIndex]] = dataArray[i][dataIndex];

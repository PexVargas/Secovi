#pragma checksum "C:\Users\WINDOWS\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b3d85151c92d147ad543bec7ff886ccf10b52458"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b3d85151c92d147ad543bec7ff886ccf10b52458", @"/Views/Home/Index.cshtml")]
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b3d85151c92d147ad543bec7ff886ccf10b524586621", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b3d85151c92d147ad543bec7ff886ccf10b524589175", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b3d85151c92d147ad543bec7ff886ccf10b5245811719", async() => {
#nullable restore
...
<div class=""row"" id=""boxGraficos"">
    ...
    <div class=""col-md-6"">
        <div class=""card"">
            <d");
            WriteLiteral(@"iv class=""card-header card-header-icon card-header-info"">
                <div class=""card-icon"">
                    <i class=""material-icons"">south_east</i>
                </div>
...
<script src=""https://code.highcharts.com/modules/accessibility.");
...
<script>
    ...
    $('.fundoFil");
            WriteLiteral(@"troLista').on('click', function () {
    ...
    ");
            WriteLiteral(@"    var cidade = $('#cmbCidade').val();
        if (data == """" || cidade == """") {
            if (data == """") {
    ...
    function CarregarGraficoMeses() {
       ...
       ");
            WriteLiteral(@"             $('#graficoEvolutivo').html('Sem registros, por favor modifique a busca!');
                } else {
            ...
            WriteLiteral(@"1].cv != null)
                            ...
                            if (todos.value < 10) {
                 ");
            WriteLiteral(@"               $('.numQtdOfe').removeClass('qtdAzul');
                                $('.numQtdOfe').addClass('qtdVermelho');
                            } else {
                                $('.numQtdOfe').removeClass('qtdVermelho');
                                $('.numQtdOfe').addClass('qtdAzul');
    ...
    function CarregarGraficoCidades() {
        ...
        $.ajax({
            ...
            url: ""/Home/GetCidades"",
            data: JSON.stringify({ cidades,");
            WriteLiteral(@" bairros, tipos, tipoimovel, DtReferencia: dtRefencia, Unidade: unidade, TipoArea: tipoArea }),
            dataType: ""json"",
            success: function (result) {
                $('.modal-loading-local').hide();
                $('#graficoCidades').show();
                if (result.length == 0) {
                    ...
                    for (i = 0; i < result.length; i++) {
                        ...
                        //else
                        if ");
            WriteLiteral(@"(pagAtual == 'Quantidade de ofertas')
    ...
    fun");
            WriteLiteral(@"ction CarregarGraficoBairros() {
        var pagAtual = $('#tituloCalculo').html();
        $('.modal-loading-local').show();
        $('#graficoBairros').hide();
        var processed_json = new Array();
            ...
            WriteLiteral(@";
                    ...
                    for (i = 1; i < dadosPivot.length; i++) {
                        ...
                        dadosGrafico.push({
                            name: dadosPivot[i].shift(),
                            ");
            WriteLiteral(@"data: dadosPivot[i]
                        });
                    }
    ...
    function CarregarGraficoTipos() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.length == 0) {
         ");
            WriteLiteral(@"           $('#graficoTipos').html('Sem registros, por favor modifique a busca!');
                } else {
                    var processed_json = [];
    ...
    function CarregarGraficoGaragens() {
        ...
        $.ajax({
            ...
            data: JSON.stringify({ cidades, bairros, tipos, tipoimovel, DtReferencia: dtRefencia, Unidade: uni");
            WriteLiteral(@"dade, TipoArea: tipoArea }),
 ...
 ");
    ...
    function getPivotArray(dataArray, rowIndex, colIndex, dataIndex) {
        ...
        for (var i = 0; i < dataArray.length; i++) {
          ...
          ");
            WriteLiteral(@"      newCols.push(dataArray[i][colIndex]);
            }
        }

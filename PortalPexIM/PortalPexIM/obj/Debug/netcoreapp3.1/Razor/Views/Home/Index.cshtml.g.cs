#pragma checksum "C:\Users\WINDOWS\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "43a1e0dd04ef7800a949f77059ea4738650bce97"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"43a1e0dd04ef7800a949f77059ea4738650bce97", @"/Views/Home/Index.cshtml")]
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "43a1e0dd04ef7800a949f77059ea4738650bce976611", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "43a1e0dd04ef7800a949f77059ea4738650bce979165", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "43a1e0dd04ef7800a949f77059ea4738650bce9711709", async() => {
#nullable restore
        ...
        <div class=""card"">
            ...
            <div class=""card-body ab"">
                <div class=""row"">
                    ...
                    <div class=""col-md-12"">
  ");
            WriteLiteral(@"                      <p class=""card-body minmaxcv "">CV: R$ <span class=""valorcv""></span></p>
                    </div>
                    <br />
                </div>
    ...
    <div class=""col-md-6"">
        <div class=""card"">
            ...
            <div class=""card-body cd"">
                ...
                <div class=""row"">
                    <div class=""col-md-12"">
                        <h3 class=""card-body numMet");
            WriteLiteral("Med\" style=\"font-size:18px\">Sem registros, por favor modifique a busca!</h3>\r\n                    </div>\r\n");
            WriteLiteral(@"
...
<script>
   ...
   ");
            ...
            WriteLiteral(@"      $('.numQtdOfe').html(todos.value.toLocaleString('pt-BR'));
                    ...
                    for (i = 0; i < result.length; i++) {
                        if (pagAtual == 'Quantidade de ofertas')
                            ...
                            processed_json.push([result[i].key, result[i].key + "" - R$"" + result");
            WriteLiteral(@"[i].value.toLocaleString('pt-BR'), result[i].value]);
                    }
    ...
    function CarregarGraficoCidades() {
        ...
        $('.modal-loading-local').show();
        $('#graficoCidades').hide();
        var processed_json = n");
            WriteLiteral(@"ew Array();
        $.ajax({
            type: ""POST"",
            contentType: ""application/json; charset=utf-8"",
            url: ""/Home/GetCidades"",
    ...
    function CarregarGraficoTipos() {
        ...
        $.ajax({
            ...
            url: ""/Home/GetTipos"",
            data: JSON.");
            WriteLiteral(@"stringify({ cidades, bairros, tipos, tipoimovel, DtReferencia: dtRefencia, Unidade: unidade, TipoArea: tipoArea }),
                ...
                if (result.length == 0) {
                    ...
                    for (i = 0; i < result.length; i++) {
                       ...
                       // else
                            if (pagAtual == 'Quantidade de ofertas')
                          ");
            WriteLiteral(@"      processed_json.push([result[i].key, result[i].key , result[i].value]);
                            else
                                processed_json.push([result[i].key, result[i].key , result[i].value]);
                    }
    ...
    function CarregarGraficoPizza(id, titulo, dados) {
        ...
        Highcharts.chart(id, {
            chart: {
                p");
            WriteLiteral(@"lotBackgroundColor: null,
    ...
    function search(nameKe");
            WriteLiteral("y, myArray) {\r\n        for (var i = 0; i < myArray.length; i++) {\r\n            if (myArray[i].name === nameKey) {\r\n                return myArray[i];\r\n            }\r\n        }\r\n    }\r\n</script>\r\n");
        }

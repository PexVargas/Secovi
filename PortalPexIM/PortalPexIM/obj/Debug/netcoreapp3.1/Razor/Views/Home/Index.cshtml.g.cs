#pragma checksum "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "49362480f6af87a11aede4d1999533f69984e4c1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"49362480f6af87a11aede4d1999533f69984e4c1", @"/Views/Home/Index.cshtml")]
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "49362480f6af87a11aede4d1999533f69984e4c16607", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "49362480f6af87a11aede4d1999533f69984e4c19157", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "49362480f6af87a11aede4d1999533f69984e4c111697", async() => {
#nullable restore
   ...
   ");
    ...
    function CarregarGraficoCidades() {
        ...
        $.ajax({
            ...
            WriteLiteral(@"s, bairros, tipos, tipoimovel, DtReferencia: dtRefencia, Unidade: unidade, TipoArea: tipoArea }),
            dataType: ""json"",
            success: function (result) {
                $('.modal-loading-local').hide();
                $('#graficoCidades').show();
           ...
           ");
            WriteLiteral(@"                 //if (pagAtual == 'Quantidade de ofertas')
                                processed_json.push([result[i].key, result[i].key, result[i].value]);
                            //else
                            //    processed_json.push([result[i].key, result[i].key + "" - R$"" + result[i].value.toLocaleString('pt-BR'), result[i].value]);
                    }
                    ...
                    CarregarGrafico(""graficoCidades"", catego");
            WriteLiteral(@"ries[0], dadosGrafico, ""Oferta por cidades"", ""bar"", ""6"");
                }
            },
            error: function (err) {
            }
    ...
    function CarregarGraficoBairros() {
        ...
        $.ajax({
            ...
            success: function (result) {
               ...
               ");
            WriteLiteral(@"     var processed_json = [];
    ...
    function CarregarGraficoTipos() {
        ...
        $.ajax({
            ...
            contentType: ""application/json; charset=utf-8"",
            url: ""/Home/GetTipos"",
            data: JSON.stringify({ cidades, bairros, tipos, tipoimovel, DtReferencia: dtRefencia, Unidade: unidade, Tip");
            WriteLiteral(@"oArea: tipoArea }),

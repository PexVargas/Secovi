#pragma checksum "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5a533bebec3dcf11251c0044b2e9b534a40b8b65"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5a533bebec3dcf11251c0044b2e9b534a40b8b65", @"/Views/Home/Index.cshtml")]
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5a533bebec3dcf11251c0044b2e9b534a40b8b656607", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5a533bebec3dcf11251c0044b2e9b534a40b8b659157", async() => {
#nullable restore
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5a533bebec3dcf11251c0044b2e9b534a40b8b6511697", async() => {
#nullable restore
        ...
        <div class=""card"">
            ...
            <div class=""card-body ab"">
                <div class=""row"">
                    ...
                    <div class=""col-md-12"">
                        <p class=""card-body minmaxcv"">min:</p>
                    </div>
                    <div class=""col-md-12"">
                        <p class=""card-body minmaxcv"">máx:</p>
                    </div>
                    <div class=""col-md-12"">
                        <p class=""card-body minmaxcv"">cv:</p>
                    </div>
    ");
            WriteLiteral(@"                <br />
                </div>
    ...
    <div class=""col-md-6"">
        <div class=""card"">
            ...
            <div class=""card-body"" id=""boxTipos"">
                <figure class=""highcharts-figure"">
                    <div clas");
            WriteLiteral(@"s=""modal-loading-local""></div>
...
<script s");
            WriteLiteral(@"rc=""https://code.highcharts.com/modules/export-data.js""></script>
...
<script>
    ...
    ");
            WriteLiteral(@"        document.querySelector(""[data-id='cmbCidade']"").classList.remove('container-vermelho');
        });
    ...
    var tipoArea = 2;
 ");
            WriteLiteral(@"   var possuiCidades = false;
 ...
 ");
            WriteLiteral(@"       if ($(""#cmbTipoArea"").is(':checked'))
            tipoArea = 1;
        else
            tipoArea = 2;
...
");
            WriteLiteral(@"        var pagAtual = $('#tituloCalculo').html();
        ...
        $.ajax({
            ...
            WriteLiteral(@"on = [];
                    ...
                    CarregarGraficoEvolutivo(""graficoEvolutivo"", c");
            WriteLiteral(@"ategories[0], dadosGrafico, ""Evolutivo de ofertas"", ""column"", ""12"");
                }
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.length == 0) {
                    ...
                    $('#graficoCidades').html('Sem registro");
            WriteLiteral(@"s, por favor modifique a busca!');
                } else {
                    possuiCidades = true;
                    var processed_json = [];
                    ...
                    var dadosPivot = getPivotArray(processed_json");
            WriteLiteral(@", 0, 1, 2);
    ...
    function CarregarGraficoGaragens() {
        ...
        $.ajax({
            ...
            success: function (result) {
                $('.modal-loading-local').hide();
 ");
            WriteLiteral(@"               $('#graficoGaragens').show();
                if (result.length == 0) {
    ...
    function getPivotArray(dataArray, rowIndex, colIndex, dataIndex) {
        ...
        for (var i = 0; i < dataArray.length; i++) {
            ...
            result[dataArray[i][rowIndex]][dataAr");
            WriteLiteral(@"ray[i][colIndex]] = dataArray[i][dataIndex];

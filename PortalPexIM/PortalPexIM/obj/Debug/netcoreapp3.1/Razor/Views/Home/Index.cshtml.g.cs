#pragma checksum "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7d872706351cd2ead18f5475ea70cbe3717019e1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7d872706351cd2ead18f5475ea70cbe3717019e1", @"/Views/Home/Index.cshtml")]
...
<div class=""funcFiltroLista"">
    <div class=""col-md-12"">
        ...
        <div class=""form-group col-md-12"">
            <select multiple id=""cmbCidade"" class=""form-control selectpicker"" data-style=""btn btn-link"" title=""Selec");
            WriteLiteral("ione a Cidade\">\r\n");
#nullable restore
#line 137 "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7d872706351cd2ead18f5475ea70cbe3717019e16607", async() => {
#nullable restore
#line 139 "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
...
#nullable disable
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 140 "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                }
...
#nullable restore
#line 146 "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7d872706351cd2ead18f5475ea70cbe3717019e19157", async() => {
#nullable restore
#line 148 "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
...
#nullable disable
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 149 "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                }
...
#nullable restore
#line 154 "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7d872706351cd2ead18f5475ea70cbe3717019e111697", async() => {
#nullable restore
#line 156 "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
...
#nullable disable
            ...
            WriteLiteral("\r\n");
#nullable restore
#line 157 "C:\Users\Person\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                }
    ...
    <div class=""col-md-12"">
        <div class=""card"">
            ...
            <div class=""card-body"">
                <div class=""row"">
                    <div class=""col-md-9"">
                        <h3 class=""card-title"" id=""tituloUnidade"">Série histórica</h3>
                    </div>
                    <div class=""col-md-3"">
                        <div class=""togglebutton radio"">
                            <label>
    ...
    <d");
        ...
        <div class=""card"">
            <div class=""card-header card-header-icon card-header-info"">
                ...
                <h3 class=""card-title"" id=""tituloCalculo"">Série histórica</h3>
            </div>
            <div class=""card-body ab"">
                <div class=""row"">
                    ...
                    <div class=""col-md-12"">
                        <p clas");
            WriteLiteral(@"s=""card-body minmaxcv valorcv"">cv:</p>
                    </div>
                    <br />
                </div>
...
<script src=""https://code.highcharts.com/modul");
            WriteLiteral(@"es/accessibility.js""></script>
...
<script>
   ...
   ");
            WriteLiteral(@"     $('.togglebutton').on('click', function () {
            preencheFiltro();
        });
        verificaPag()
    });
        ...
        function getUrlParameter(sParam) {
            ...
            for (i = 0; i < sURLVariables.length; i++) {
                ...
                if (sParameterName[0] === sParam) {
                    return sParameterName[1] === undefine");
            WriteLiteral(@"d ? true : decodeURIComponent(sParameterName[1]);
                }
            }
        };
    ...
    functi");
            WriteLiteral(@"on preencheFiltro() {
    ...
    function CarregarGraficoMeses() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.length == 0) {
                    if (possuiCidades == false) {
                        ...
                        $('.numQtdOfe').html('<span class=""nu");
            WriteLiteral(@"mSemNum"">Sem registros, por favor modifique a busca!</span>');
                    }
            ...
            WriteLiteral(@" $('.valormin').html(result[result.length - 1].minimo.toLocaleString('pt-BR'));
                            ...
                            if (todos.value < 10) {
                                $('.numQtdOfe').removeClass");
            WriteLiteral(@"('qtdAzul');
                                $('.numQtdOfe').addClass('qtdVermelho');
                            } else {
                                $('.numQtdOfe').removeClass('qtdVermelho');
                                $('.numQtdOfe').addClass('qtdAzul');
                    ...
                    for (i = 0; i < result.length; i++) {
                        if (pagAtual == 'Quantidade de ofertas')
                            processed_json.push([result[i].key, result[i].key + "" - "" + result[i].value, result[i].value].toLocaleString('pt-BR'));
                        else
   ...
   ");
            WriteLiteral(@"                     else
                            if (pagAtual == 'Quantidade de ofertas')
                                processed_json.push([result[i].key, result[i].key + "" - "" + result[i].value.toLocaleString('pt-BR'), result[i].value]);
                            else
                                processed_json.push([result[i].key, result[i].key + "" - R$"" + result[i].value.toLocaleString('pt-BR'), result[i].value]);
                    }
...
");
    ...
    function CarregarGraficoBairros() {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.length == 0) {
                    $('#graficoBairros').html('Sem reg");
            WriteLiteral(@"istros, por favor modifique a busca!');
                } else {
                    var processed_json = [];
                    ...
                    var dadosPivot = getPivotArray(proc");
            WriteLiteral(@"essed_json, 0, 1, 2);
    ...
    function CarregarGraficoTipos() {
        ...
        $.ajax({
            ...
            url: ""/Home/GetTipos"",
 ");
            WriteLiteral(@"           data: JSON.stringify({ cidades, bairros, tipos, tipoimovel, DtReferencia: dtRefencia, Unidade: unidade, TipoArea: tipoArea }),
                ...
                if (result.length == 0) {
                    ...
                    for (i = 0; i < result.length; i++) {
                        ...
                        if (i >= 15) {
                            ...
                            if (pagAtual == 'Quantidade de ofertas')
                ");
            WriteLiteral(@"                processed_json.push([result[i].key, result[i].key + "" - "" + result[i].value.toLocaleString('pt-BR'), result[i].value]);
                            else
                                processed_json.push([result[i].key, result[i].key + "" - R$"" + result[i].value.toLocaleString('pt-BR'), result[i].value]);
                    }
    ...
    function CarregarGrafico(id, categories, dadosGrafico, titulo, tipo, colmd) {
        ...
        Highcharts.chart(id, {
         ...
         ");
            WriteLiteral(@"   series: dadosGrafico
        });
    }
    ...
    function CarregarGraficoPizza(id, t");
            WriteLiteral(@"itulo, dados) {

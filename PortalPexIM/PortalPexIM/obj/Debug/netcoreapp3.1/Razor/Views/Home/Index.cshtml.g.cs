#pragma checksum "C:\Users\WINDOWS\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "46fdad55285fafcf4ab69d8a86f37cb1978ff76f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"46fdad55285fafcf4ab69d8a86f37cb1978ff76f", @"/Views/Home/Index.cshtml")]
...
#nullable restore
#line 137 "C:\Users\WINDOWS\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "46fdad55285fafcf4ab69d8a86f37cb1978ff76f6611", async() => {
#nullable restore
#line 139 "C:\Users\WINDOWS\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
...
#nullable restore
#line 146 "C:\Users\WINDOWS\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "46fdad55285fafcf4ab69d8a86f37cb1978ff76f9165", async() => {
#nullable restore
...
#nullable restore
#line 154 "C:\Users\WINDOWS\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "46fdad55285fafcf4ab69d8a86f37cb1978ff76f11709", async() => {
#nullable restore
#line 156 "C:\Users\WINDOWS\Documents\GitHub\Secovi\PortalPexIM\PortalPexIM\Views\Home\Index.cshtml"
                                      Write(itens);
        ...
        <div class=""card"">
            ...
            <div class=""card-body ab"">
                <div class=""row"">
                    ...
                    <div class=""col-md-12"">
                        <p class=""card-body minmaxcv "">min: <span class=""valormin""></span></p>
                    </div>
                    <div class=""col-md-12"">
                        <p class=""card-body minmaxcv "">máx: <span class=""valormax""></span></p>
                    </div>
                    <div class=""col-md-12"">
                        <p clas");
   ...
   ");
    ...
    function CarregarGraficoCidades() {
        ...
        $.ajax({
            ...
            contentType: ""application/json; charset=utf-8"",
            url: ""/Home/GetCidades"",
            data: JSON.stringify({ cidades, bairros, tipos, tipoimovel, DtReferencia: dtRefencia, Unidade: unidade, TipoArea: tipoAre");
            WriteLiteral(@"a }),
            dataType: ""json"",
            success: function (result) {
                $('.modal-loading-local').hide();
                ...
                if (result.length == 0) {
                    ...
                    for (i = 0; i < result.length; i++) {
                        ...
                        if (i >= 15) {
                            ...
                            if (pagAtual == 'Quantidade de ofertas')
                                process");
            WriteLiteral(@"ed_json.push([result[i].key, result[i].key + "" - "" + result[i].value, result[i].value]);
                            else
                                processed_json.push([result[i].key, result[i].key + "" - R$"" + result[i].value, result[i].value]);
                    }
...
");
                    ...
                    for (i = 0; i < result.length; i++) {
                        ...
                        if (i >= 15) {
                            ...
                            if (pagAtual == 'Quantidade de ofertas')
                                ...
                                processed_json.push([result[i].key, result[i].key + """);
            WriteLiteral(@" - R$"" + result[i].value, result[i].value]);
                    }
  ...
  ");
    ...
    function getPivotArray(dataArray, rowIndex, colIndex, ");
            WriteLiteral(@"dataIndex) {
